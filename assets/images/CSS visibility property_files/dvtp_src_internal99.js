...
window._dv_win.frames&&window._dv_win.frames[b.name]&&window._dv_win.frames[b.name].document)return c}catch(d){}return null}function V(b){var c=document.createElement("iframe");c.name=c.id=window._dv_win.dv_config.emptyIframeID||"iframe_"+Math.floor(1E12*(Math.random()+""));c.width=0;c.height=0;c.style.display="none";c.src=b;return c}function ha(b,c,d,e,g,k){var r=window._dv_win.dv_config=window._dv_win.dv_config||{};r.tpsErrAddress=r.tpsAddress||"tps30.doubleverify.com";r.cdnAddress=r.cdnAddress||
"cdn.doubleverify.com";var p={};p[b]=c;p.dvp_jsErrUrl=d;p.dvp_jsErrMsg=encodeURIComponent("Error loading visit.js");b=dv_CreateAndGetErrorImp(r.tpsErrAddress+"/visit.jpg?ctx=818052&cmp=1619415&dvtagver=6.1.src&dvp_isLostImp=1",p);return'<html><head><script type="text/javascript">('+function(b){try{window.dvSrc=b,window.$dv=window.$dv||parent.$dv,window.$dv.dvObjType="dv",window.$frmId=Math.random().toString(36)+Math.random().toString(36)}catch(h){}}.toString()+')("'+k+'");\x3c/script></head><body><script type="text/javascript">('+
(e||"function() {}")+')("'+g+'");\x3c/script><script type="text/javascript" id="TPSCall" src="'+d+'">\x3c/script><script type="text/javascript">('+function(b){var c=document.getElementById("TPSCall");try{c.onerror=function(){try{(new Image).src=b}catch(u){}}}catch(u){}c&&c.readyState?(c.onreadystatechange=function(){"complete"==c.readyState&&document.close()},"complete"==c.readyState&&document.close()):document.close()}.toString()+')("'+b+'");\x3c/script></body></html>'}function W(b){var c={};try{for(var d=
/[\?&]([^&]*)=([^&#]*)/gi,e=d.exec(b);null!=e;)"eparams"!==e[1]&&(c[e[1]]=e[2]),e=d.exec(b);return c}catch(g){return c}}function ia(b){for(var c=0;10>c&&b!=window._dv_win.top;)c++,b=b.parent;return c}function ja(b){try{if(1>=b.depth)return{url:"",depth:""};var c=[];c.push({win:window._dv_win.top,depth:0});for(var d,e=1,g=0;0<e&&100>g;){try{if(g++,d=c.shift(),e--,0<d.win.location.toString().length&&d.win!=b)return 0==d.win.document.referrer.length||0==d.depth?{url:d.win.location,depth:d.depth}:{url:d.win.document.referrer,
depth:d.depth-1}}catch(p){}var k=d.win.frames.length;for(var r=0;r<k;r++)c.push({win:d.win.frames[r],depth:d.depth+1}),e++}return{url:"",depth:""}}catch(p){return{url:"",depth:""}}}function ka(){var b=window._dv_win[S("=@42E:@?")][S("2?46DE@C~C:8:?D")];if(b&&0<b.length){var c=[];c[0]=window._dv_win.location.protocol+"//"+window._dv_win.location.hostname;for(var d=0;d<b.length;d++)c[d+1]=b[d];return c.reverse().join(",")}return null}function S(b){var c=String(),d;for(d=0;d<b.length;d++){var e=b.charAt(d);
var g="!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~".indexOf(e);0<=g&&(e="!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~".charAt((g+47)%94));c+=e}return c}function la(){try{var b=0,c=function(c,d){d&&32>c&&(b=(b|1<<c)>>>0)},d=function(b,c){return function(){return b.apply(c,arguments)}},e="svg"===document.documentElement.nodeName.toLowerCase(),g=function(){return"function"!==typeof document.createElement?
document.createElement(arguments[0]):e?document.createElementNS.call(document,"http://www.w3.org/2000/svg",arguments[0]):document.createElement.apply(document,arguments)},k=["Moz","O","ms","Webkit"],r=["moz","o","ms","webkit"],p={style:g("modernizr").style},m=function(b,c,d,e){function h(){m&&(delete p.style,delete p.modElem)}e="undefined"===typeof e?!1:e;if("undefined"!==typeof d){var k=nativeTestProps(b,d);if("undefined"!==typeof k)return k}for(k=["modernizr","tspan","samp"];!p.style&&k.length;){var m=
!0;p.modElem=g(k.shift());p.style=p.modElem.style}var u=b.length;for(k=0;k<u;k++){var f=b[k];var r=p.style[f];~(""+f).indexOf("-")&&(f=cssToDOM(f));if(void 0!==p.style[f]){if(e||"undefined"===typeof d)return h(),"pfx"==c?f:!0;try{p.style[f]=d}catch(A){}if(p.style[f]!=r)return h(),"pfx"==c?f:!0}}h();return!1},h=function(b,c,g,e,h){var l=b.charAt(0).toUpperCase()+b.slice(1),p=(b+" "+k.join(l+" ")+l).split(" ");if("string"===typeof c||"undefined"===typeof c)return m(p,c,e,h);p=(b+" "+r.join(l+" ")+l).split(" ");
for(var u in p)if(p[u]in c){if(!1===g)return p[u];b=c[p[u]];return"function"===typeof b?d(b,g||c):b}return!1};c(0,!0);c(1,!!function(b,c,d){if(0===b.indexOf("@"))return atRule(b);-1!=b.indexOf("-")&&(b=cssToDOM(b));return c?h(b,c,d):h(b,"pfx")}("requestFileSystem",window));c(2,window.CSS?"function"==typeof window.CSS.escape:!1);c(3,h("shapeOutside","content-box",!0));return b}catch(u){return 0}}function ma(){try{var b=window,c=0;try{for(;b.parent&&b!=b.parent&&b.parent.document&&!(b=b.parent,10<c++););
}catch(e){}var d=0;c=function(b,c){c&&(d=(d|1<<b)>>>0)};c(14,b.playerInstance&&b.document.querySelector('script[src*="ads-player.com"]'));c(15,b.zpz&&b.zpz.createPlayer);c(16,b.xy_checksum&&b.place_player&&b.logjwonready&&b.logContentPauseRequested);c(17,b==b.top&&""==b.document.title?(a=b.document.querySelector('body>object[id="player"]'),a&&a.data&&1<a.data.indexOf("jwplayer")&&"visibility: visible;"==a.getAttribute("style")):!1);c(17,b.document.querySelector('script[src*="sitewebvideo.com"]'));
c(17,b.InitPage&&b.cef&&b.InitAd);return d}catch(e){return 0}}function na(){function b(b){if(null==b||""==b)return"";var c=function(b,c){return b<<c|b>>>32-c},d=function(b){for(var c="",d,f=7;0<=f;f--)d=b>>>4*f&15,c+=d.toString(16);return c},g=[1518500249,1859775393,2400959708,3395469782];b+=String.fromCharCode(128);for(var e=Math.ceil((b.length/4+2)/16),k=Array(e),t=0;t<e;t++){k[t]=Array(16);for(var v=0;16>v;v++)k[t][v]=b.charCodeAt(64*t+4*v)<<24|b.charCodeAt(64*t+4*v+1)<<16|b.charCodeAt(64*t+4*
v+2)<<8|b.charCodeAt(64*t+4*v+3)}k[e-1][14]=8*(b.length-1)/Math.pow(2,32);k[e-1][14]=Math.floor(k[e-1][14]);k[e-1][15]=8*(b.length-1)&4294967295;b=1732584193;v=4023233417;var l=2562383102,K=271733878,I=3285377520,E=Array(80);for(t=0;t<e;t++){for(var q=0;16>q;q++)E[q]=k[t][q];for(q=16;80>q;q++)E[q]=c(E[q-3]^E[q-8]^E[q-14]^E[q-16],1);var f=b;var z=v;var A=l;var y=K;var G=I;for(q=0;80>q;q++){var B=Math.floor(q/20),L=c(f,5);a:{switch(B){case 0:var M=z&A^~z&y;break a;case 1:M=z^A^y;break a;case 2:M=z&
A^z&y^A&y;break a;case 3:M=z^A^y;break a}M=void 0}B=L+M+G+g[B]+E[q]&4294967295;G=y;y=A;A=c(z,30);z=f;f=B}b=b+f&4294967295;v=v+z&4294967295;l=l+A&4294967295;K=K+y&4294967295;I=I+G&4294967295}return d(b)+d(v)+d(l)+d(K)+d(I)}function c(){try{return!!window.sessionStorage}catch(k){return!0}}function d(){try{return!!window.localStorage}catch(k){return!0}}function e(){var b=document.createElement("canvas");if(b.getContext&&b.getContext("2d")){var c=b.getContext("2d");c.textBaseline="top";c.font="14px 'Arial'";
c.textBaseline="alphabetic";c.fillStyle="#f60";c.fillRect(0,0,62,20);c.fillStyle="#069";c.fillText("!image!",2,15);c.fillStyle="rgba(102, 204, 0, 0.7)";c.fillText("!image!",4,17);return b.toDataURL()}return null}try{var g=[];g.push(["lang",navigator.language||navigator.browserLanguage]);g.push(["tz",(new Date).getTimezoneOffset()]);g.push(["hss",c()?"1":"0"]);g.push(["hls",d()?"1":"0"]);g.push(["odb",typeof window.openDatabase||""]);g.push(["cpu",navigator.cpuClass||""]);g.push(["pf",navigator.platform||
""]);g.push(["dnt",navigator.doNotTrack||""]);g.push(["canv",e()]);return b(g.join("=!!!="))}catch(k){return null}}this.createRequest=function(){function b(b,c){var f={};try{if(b.performance&&b.performance.getEntries){var C=b.performance.getEntries();for(b=0;b<C.length;b++){var e=C[b],g=e.name.match(/.*\/(.+?)\./);if(g&&g[1]){var h=g[1].replace(/\d+$/,""),k=c[h];if(k){for(var m=0;m<k.stats.length;m++){var l=k.stats[m];f[k.prefix+l.prefix]=Math.round(e[l.name])}delete c[h];if(!d(c))break}}}}return f}catch(qa){}}
function c(c,f){var e;if(c.frames)for(var C=0;C<c.frames.length;C++)if((e=b(c.frames[C],f))&&d(e))return e}function d(b){var c=0,d;for(d in b)b.hasOwnProperty(d)&&++c;return c}function e(b){if(b&&d(b))for(var c in b)b.hasOwnProperty(c)&&D.push(c+"="+b[c]);else D.push("dvp_noperf=1")}window._dv_win.$dv.isEval=1;window._dv_win.$dv.DebugInfo={};var g=!1,k=!1,r,p,m=!1,h=window._dv_win,u=0,t=!1,v=getCurrentTime();window._dv_win.t2tTimestampData=[{dvTagCreated:v}];var l;try{for(l=0;10>=l;l++)if(null!=h.parent&&
h.parent!=h)if(0<h.parent.location.toString().length)h=h.parent,u++,m=!0;else{m=!1;break}else{0==l&&(m=!0);break}}catch(C){m=!1}0==h.document.referrer.length?l=h.location:m?l=h.location:(l=h.document.referrer,t=!0);var K="",I=null,E=null;try{window._dv_win.external&&(I=void 0!=window._dv_win.external.QueuePageID?window._dv_win.external.QueuePageID:null,E=void 0!=window._dv_win.external.CrawlerUrl?window._dv_win.external.CrawlerUrl:null)}catch(C){K="&dvp_extErr=1"}if(!window._dv_win._dvScriptsInternal||
!window._dv_win.dvProcessed||0==window._dv_win._dvScriptsInternal.length)return null;m=window._dv_win._dvScriptsInternal.pop();var q=m.script;this.dv_script_obj=m;this.dv_script=q;window._dv_win.t2tTimestampData[0].dvWrapperLoadTime=m.loadtime;window._dv_win.dvProcessed.push(m);var f=q.src;this.dv_script_obj.dvSrc=f;void 0!=window._dv_win.$dv.CommonData.BrowserId&&void 0!=window._dv_win.$dv.CommonData.BrowserVersion&&void 0!=window._dv_win.$dv.CommonData.BrowserIdFromUserAgent?m={ID:window._dv_win.$dv.CommonData.BrowserId,
version:window._dv_win.$dv.CommonData.BrowserVersion,ID_UA:window._dv_win.$dv.CommonData.BrowserIdFromUserAgent}:(m=dv_GetParam(f,"useragent"),m=(new BrowserDetector).getBrowserIdAndVersion(m?decodeURIComponent(m):navigator.userAgent),window._dv_win.$dv.CommonData.BrowserId=m.ID,window._dv_win.$dv.CommonData.BrowserVersion=m.version,window._dv_win.$dv.CommonData.BrowserIdFromUserAgent=m.ID_UA);var z=!0,A=window.parent.postMessage&&window.JSON,y=!1;if("0"==dv_GetParam(f,"t2te")||window._dv_win.dv_config&&
!0===window._dv_win.dv_config.supressT2T)y=!0;if(A&&!1===y&&5!=window._dv_win.$dv.CommonData.BrowserId)try{var G=V(window._dv_win.dv_config.t2turl||"https://cdn3.doubleverify.com/t2tv7.html");z=Q(G)}catch(C){}window._dv_win.$dv.DebugInfo.dvp_HTML5=A?"1":"0";var B=dv_GetParam(f,"region")||"",L=(/iPhone|iPad|iPod|\(Apple TV|iOS|Coremedia|CFNetwork\/.*Darwin/i.test(navigator.userAgent)||navigator.vendor&&"apple, inc."===navigator.vendor.toLowerCase())&&!window.MSStream,M=L?"https:":aa(),N=L?"https:":
ba(f);y="0";"https:"===N&&(y="1");try{h.depth=ia(h);var w=ja(h);dv_aUrlParam="&aUrl="+encodeURIComponent(w.url);dv_aUrlDepth="&aUrlD="+w.depth;dv_referrerDepth=h.depth+u;t&&h.depth--}catch(C){dv_aUrlDepth=dv_aUrlParam=dv_referrerDepth=h.depth=""}u=dv_GetDynamicParams(f,"dvp");t=dv_GetDynamicParams(f,"dvpx");for(w=0;w<t.length;w++){var n=dv_GetKeyValue(t[w]);t[w]=n.key+"="+encodeURIComponent(n.value)}"41"==B&&(B=50>100*Math.random()?"41":"8",u.push("dvp_region="+B));u=u.join("&");t=t.join("&");B=window._dv_win.dv_config.tpsAddress||
"tps"+B+".doubleverify.com";w="visit.js";switch(dv_GetParam(f,"dvapi")){case "1":w="dvvisit.js";break;case "5":w="query.js";break;default:w="visit.js"}window._dv_win.$dv.DebugInfo.dvp_API=w;var x="ctx cmp ipos sid plc adid crt btreg btadsrv adsrv advid num pid crtname unit chnl uid scusrid tagtype sr dt dup app dvvidver".split(" "),D=[];for(n=0;n<x.length;n++){var J=dv_GetParam(f,x[n])||"";D.push(x[n]+"="+J);""!==J&&(window._dv_win.$dv.DebugInfo["dvp_"+x[n]]=J)}x="turl icall dv_callback useragent xff timecheck seltag sadv ord litm scrt invs splc adu native gmnpo".split(" ");
for(n=0;n<x.length;n++)J=dv_GetParam(f,x[n]),null!=J&&D.push(x[n]+"="+(J||""));(n=dv_GetParam(f,"isdvvid")||"")&&D.push("isdvvid=1");x=dv_GetParam(f,"tagtype")||"";var H=window._dv_win.$dv.getMraid();a:{try{if("object"==typeof window.$ovv||"object"==typeof window.parent.$ovv){var F=!0;break a}}catch(C){}F=!1}J=ea(H,f);D.push("sup="+J);1==n||H||"video"!=x&&"1"!=x||(n=dv_GetParam(f,"adid")||"","function"===typeof _dv_win[n]&&(D.push("prplyd=1"),D.push("DVP_GVACB="+n),D.push("isdvvid=1")),n="AICB_"+
(window._dv_win.dv_config&&window._dv_win.dv_config.dv_GetRnd?window._dv_win.dv_config.dv_GetRnd():dv_GetRnd()),window._dv_win[n]=function(b){g=!0;r=b;window._dv_win.$dv&&1==k&&window._dv_win.$dv.registerEventCall(p,{prplyd:0,dvvidver:b})},D.push("AICB="+n),n=D.join("&"),x=window._dv_win.document.createElement("script"),x.src=N+"//cdn.doubleverify.com/dvvid_src.js?"+n,window._dv_win.document.body.appendChild(x));try{var T=b(window,{dvtp_src:{prefix:"d",stats:[{name:"fetchStart",prefix:"fs"},{name:"duration",
prefix:"dur"}]},dvtp_src_internal:{prefix:"dv",stats:[{name:"duration",prefix:"dur"}]}});e(T)}catch(C){}T=D.join("&");n=na();n=null!=n?"&aadid="+n:"";var X=f;B=window._dv_win.dv_config.visitJSURL||N+"//"+B+"/"+w;L=L?"&dvf=0":"";w=Z("maple")?"&dvf=1":"";f=B+"?"+T+"&dvtagver=6.1.src&srcurlD="+h.depth+"&curl="+(null==E?"":encodeURIComponent(E))+"&qpgid="+(null==I?"":I)+"&ssl="+y+L+w+"&refD="+dv_referrerDepth+"&htmlmsging="+(A?"1":"0")+n+K;H&&(f+="&ismraid=1");F&&(f+="&isovv=1");f+=fa();"http:"==f.match("^http:")&&
"https"==window._dv_win.location.toString().match("^https")&&(f+="&dvp_diffSSL=1");h=q&&q.parentElement&&q.parentElement.tagName&&"HEAD"===q.parentElement.tagName;if(!1===z||h)f+="&dvp_isBodyExistOnLoad="+(z?"1":"0"),f+="&dvp_isOnHead="+(h?"1":"0");u&&(f+="&"+u);t&&(f+="&"+t);h="srcurl="+encodeURIComponent(l);window._dv_win.$dv.DebugInfo.srcurl=l;(l=ka())&&(h+="&ancChain="+encodeURIComponent(l));l=dv_GetParam(f,"uid");null==l?(l=dv_GetRnd(),f+="&uid="+l):(l=dv_GetRnd(),f=f.replace(/([?&]uid=)(?:[^&])*/i,
"$1"+l));l=4E3;/MSIE (\d+\.\d+);/.test(navigator.userAgent)&&7>=new Number(RegExp.$1)&&(l=2E3);F=navigator.userAgent.toLowerCase();if(-1<F.indexOf("webkit")||-1<F.indexOf("chrome"))F="&referrer="+encodeURIComponent(window._dv_win.location),f.length+F.length<=l&&(f+=F);navigator&&navigator.userAgent&&(F="&navUa="+encodeURIComponent(navigator.userAgent),f.length+F.length<=l&&(f+=F));dv_aUrlParam.length+dv_aUrlDepth.length+f.length<=l&&(f+=dv_aUrlDepth,h+=dv_aUrlParam);l=ca();f+="&vavbkt="+l.vdcd;f+=
"&lvvn="+l.vdcv;f+="&"+this.getVersionParamName()+"="+this.getVersion();f+="&eparams="+encodeURIComponent(S(h));""!=l.err&&(f+="&dvp_idcerr="+encodeURIComponent(l.err));m.ID&&(f+="&brid="+m.ID+"&brver="+m.version+"&bridua="+m.ID_UA+"&bds=1",window._dv_win.$dv.DebugInfo.dvp_BRID=m.ID,window._dv_win.$dv.DebugInfo.dvp_BRVR=m.version,window._dv_win.$dv.DebugInfo.dvp_BRIDUA=m.ID_UA);void 0!=window._dv_win.$dv.CommonData.Scenario?m=window._dv_win.$dv.CommonData.Scenario:(m=this.getTrafficScenarioType(window._dv_win),
window._dv_win.$dv.CommonData.Scenario=m);f+="&tstype="+m;window._dv_win.$dv.DebugInfo.dvp_TS=m;var O="";try{window.top==window?O="1":window.top.location.host==window.location.host&&(O="2")}catch(C){O="3"}var P=window._dv_win.document.visibilityState,Y=function(){var b=!1;try{b=H&&"function"===typeof H.getState&&"loading"===H.getState()}catch(pa){f+="&dvp_mrgsf=1"}return b},U=Y();if("prerender"===P||U)f+="&prndr=1",U&&(f+="&dvp_mrprndr=1");m="dvCallback_"+(window._dv_win.dv_config&&window._dv_win.dv_config.dv_GetRnd?
window._dv_win.dv_config.dv_GetRnd():dv_GetRnd());var R=this.dv_script;window._dv_win[m]=function(b,d,e,h){var m=getCurrentTime();k=!0;p=e;d.$uid=e;var l=W(X);b.tags.add(e,l);l=W(f);b.tags[e].set(l);b.tags[e].beginVisitCallbackTS=m;b.tags[e].set({tagElement:R,dv_protocol:N,protocol:M,uid:e});b.tags[e].ImpressionServedTime=getCurrentTime();b.tags[e].getTimeDiff=function(){return(new Date).getTime()-this.ImpressionServedTime};try{"undefined"!=typeof h&&null!==h&&(b.tags[e].ServerPublicDns=h),b.tags[e].adServingScenario=
O,b.tags[e].t2tIframeCreationTime=v,b.tags[e].t2tProcessed=!1,b.tags[e].t2tIframeId=G.id,b.tags[e].t2tIframeWindow=G.contentWindow,$dv.t2tEventDataZombie[G.id]&&(b.tags[e].uniquePageViewId=$dv.t2tEventDataZombie[G.id].uniquePageViewId,$dv.processT2TEvent($dv.t2tEventDataZombie[G.id],b.tags[e]))}catch(oa){}b.messages&&b.messages.startSendingEvents&&b.messages.startSendingEvents(d,e);1==g&&b.registerEventCall(e,{prplyd:0,dvvidver:r});(function(){function c(){var d=window._dv_win.document.visibilityState;
"prerender"===P&&"prerender"!==d&&"unloaded"!==d&&(P=d,b.tags[e].set({prndr:0}),b.registerEventCall(e,{prndr:0}),b&&b.pubSub&&b.pubSub.publishHistoryRtnEvent(e),window._dv_win.document.removeEventListener(g,c))}function d(){"function"===typeof H.removeEventListener&&H.removeEventListener("ready",d);b.tags[e].set({prndr:0});b.registerEventCall(e,{prndr:0});b&&b.pubSub&&b.pubSub.publishHistoryRtnEvent(e)}if("prerender"===P){var f=window._dv_win.document.visibilityState;if("prerender"!==f&&"unloaded"!==
...
typeof H.addEventListener&&H.addEventListener("ready",d):(b.tags[e].set({prndr:0}),b.registerEventCall(e,{prndr:0}),b&&b.pubSub&&b.pubSub.publishHistoryRtnEvent(e)))})();try{var n=c(window,{visit:{prefix:"v",stats:[{name:"duration",prefix:"dur"}]}});n&&$dv.registerEventCall(e,n)}catch(oa){}};(h=la())&&(f+="&m1="+h);(h=ma())&&(f+="&bsig="+h);(h=da(X))&&(f+="&"+h);return f+"&jsCallback="+m};this.sendRequest=function(b){window._dv_win.t2tTimestampData.push({beforeVisitCall:getCurrentTime()});var c=this.dv_script_obj&&
this.dv_script_obj.injScripts,d=this.dv_script_obj&&this.dv_script_obj.srcLocation,e=this.dv_script_obj&&this.dv_script_obj.dvSrc;c=ha(this.getVersionParamName(),this.getVersion(),b,c,d,e);b=V("about:blank");d=b.id.replace("iframe_","");b.setAttribute&&b.setAttribute("data-dv-frm",d);Q(b,this.dv_script);if(this.dv_script){this.dv_script.id="script_"+d;d=this.dv_script;a:{e=null;try{if(e=b.contentWindow){var g=e;break a}}catch(k){}try{if(e=window._dv_win.frames&&window._dv_win.frames[b.name]){g=e;
break a}}catch(k){}g=null}d.dvFrmWin=g}if(g=R(b))g.open(),g.write(c);else{try{document.domain=document.domain}catch(k){}g=encodeURIComponent(c.replace(/'/g,"\\'").replace(/\n|\r\n|\r/g,""));b.src='javascript: (function(){document.open();document.domain="'+window.document.domain+"\";document.write('"+g+"');})()"}return!0};this.isApplicable=function(){return!0};this.onFailure=function(){window._dv_win._dvScriptsInternal.unshift(this.dv_script_obj);var b=window._dv_win.dvProcessed,c=this.dv_script_obj;
null!=b&&void 0!=b&&c&&(c=b.indexOf(c),-1!=c&&b.splice(c,1));return window._dv_win.$dv.DebugInfo};this.getTrafficScenarioType=function(b){b=b||window;var c=b._dv_win.$dv.Enums.TrafficScenario;try{if(b.top==b)return c.OnPage;for(var d=0;b.parent!=b&&1E3>d;){if(b.parent.document.domain!=b.document.domain)return c.CrossDomain;b=b.parent;d++}return c.SameDomain}catch(e){}return c.CrossDomain};this.getVersionParamName=function(){return"jsver"};this.getVersion=function(){return"140"}};
